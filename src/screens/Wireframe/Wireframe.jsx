  ...
  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white overflow-hidden w-[1440px] h-[1935px] relative">
        <img
          className="absolute w-[474px] h-[640px] top-[1078px] left-[30px]"
          alt="Image"
          src="/img/image-6.png"
        />
      ...
      <a href="https://linktr.ee/genieartwork" target="_blank" rel="noopener noreferrer">
        ...
        <div className="absolute w-[514px] h-[200px] top-5 left-10">
          <img
            className="absolute w-[200px] h-[200px] top-0 left-[314px] object-cover"
            alt="Szzaer x"
            src="/img/szza5er8-400x400-1.png"
          />

          <div className="absolute w-[358px] h-[81px] top-[55px] left-0 [text-shadow:0px_4px_4px_#00000040] [font-family:'Cabin_Sketch',Helvetica] font-bold text-[#1d1d1b] text-[50px] text-center tracking-[-1.50px] leading-[50px]">
            GENIE ART WORK
          </div>
        </div>
      </div>
